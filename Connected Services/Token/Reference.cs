...
namespace Token
{
    ...
    public interface ITokens
    {
        ...
        System.Threading.Tasks.Task<Token.tokenResponse> MakeTokenAsync(string amount, string merchantId, string invoiceNo, string paymentId, string specialPaymentId, string revertURL, string description);
        ...
        System.Threading.Tasks.Task<Token.tokenResponse> MakeSpecialTokenAsync(string amount, string merchantId, string invoiceNo, string paymentId, string specialPaymentId, string revertURL, string description, string extraParam1, string extraParam2, string extraParam3, string extraParam4);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public interface ITokensChannel : Token.ITokens, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public partial class TokensClient : System.ServiceModel.ClientBase<Token.ITokens>, Token.ITokens
    {
        ...
        public System.Threading.Tasks.Task<Token.tokenResponse> MakeTokenAsync(string amount, string merchantId, string invoiceNo, string paymentId, string specialPaymentId, string revertURL, string description)
        {
            return base.Channel.MakeTokenAsync(amount, merchantId, invoiceNo, paymentId, specialPaymentId, revertURL, description);
        }
        
        public System.Threading.Tasks.Task<Token.tokenResponse> MakeSpecialTokenAsync(string amount, string merchantId, string invoiceNo, string paymentId, string specialPaymentId, string revertURL, string description, string extraParam1, string extraParam2, string extraParam3, string extraParam4)
        {

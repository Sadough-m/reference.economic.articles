...
namespace Verify
{
    ...
    public partial class ResponseOfApiSpecialVerifyResponseXceKj1Fg : object
    {
        ...
        private Verify.ApiSpecialVerifyResponse resultField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Verify.ApiSpecialVerifyResponse result
        {
            get
            {
    ...
    public partial class ResponseOfApiRevereseResponseXceKj1Fg : object
    {
        ...
        private Verify.ApiRevereseResponse resultField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Verify.ApiRevereseResponse result
        {
            get
            {
                return this.resultField;
    ...
    public interface IVerify
    {
        ...
        System.Threading.Tasks.Task<Verify.ResponseOfApiSpecialVerifyResponseXceKj1Fg> KicccSpecialVerificationAsync(string token, string merchantId, string referenceNumber);
        ...
        System.Threading.Tasks.Task<Verify.ResponseOfApiRevereseResponseXceKj1Fg> KicccReverseAsync(string token, string merchantId, string referenceNumber);
        ...
        System.Threading.Tasks.Task<Verify.transactionModel> getTransactionAsync(string merchantId, string invoiceNo, string referenceNo);
        ...
        System.Threading.Tasks.Task<Verify.transactionModel> transactionInqueryAsync(string token, string merchantId);
        ...
        System.Threading.Tasks.Task<Verify.transactionModel> getLimitedTransacctionAsync(string merchantId, string invoiceNo, string amount);
        ...
        System.Threading.Tasks.Task<Verify.transactionModel[]> getDailyTransactionAsync(string merchantId, string offset, string limit);
        ...
        System.Threading.Tasks.Task<Verify.transactionModel[]> getOfflineTransactionAsync(string merchantId, string fromDate, string toDate, string offset, string limit);
        ...
        System.Threading.Tasks.Task<Verify.transactionModel[]> getTransactionByIbanAsync(string merchantId, string IbanNo, string fromDate, string toDate, string offset, string limit);
        ...
        System.Threading.Tasks.Task<Verify.CardModel[]> GetCardsPerKeyAsync(string merchantId, string key);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public interface IVerifyChannel : Verify.IVerify, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.1")]
    public partial class VerifyClient : System.ServiceModel.ClientBase<Verify.IVerify>, Verify.IVerify
    {
        ...
        public System.Threading.Tasks.Task<Verify.ResponseOfApiSpecialVerifyResponseXceKj1Fg> KicccSpecialVerificationAsync(string token, string merchantId, string referenceNumber)
        {
            return base.Channel.KicccSpecialVerificationAsync(token, merchantId, referenceNumber);
        }
        
        public System.Threading.Tasks.Task<Verify.ResponseOfApiRevereseResponseXceKj1Fg> KicccReverseAsync(string token, string merchantId, string referenceNumber)
        {
            return base.Channel.KicccReverseAsync(token, merchantId, referenceNumber);
        }
        
        public System.Threading.Tasks.Task<Verify.transactionModel> getTransactionAsync(string merchantId, string invoiceNo, string referenceNo)
        {
            return base.Channel.getTransactionAsync(merchantId, invoiceNo, referenceNo);
        }
        
        public System.Threading.Tasks.Task<Verify.transactionModel> transactionInqueryAsync(string token, string merchantId)
        {
            return base.Channel.transactionInqueryAsync(token, merchantId);
        }
        
        public System.Threading.Tasks.Task<Verify.transactionModel> getLimitedTransacctionAsync(string merchantId, string invoiceNo, string amount)
        {
            return base.Channel.getLimitedTransacctionAsync(merchantId, invoiceNo, amount);
        }
        
        public System.Threading.Tasks.Task<Verify.transactionModel[]> getDailyTransactionAsync(string merchantId, string offset, string limit)
        {
            return base.Channel.getDailyTransactionAsync(merchantId, offset, limit);
        }
        
        public System.Threading.Tasks.Task<Verify.transactionModel[]> getOfflineTransactionAsync(string merchantId, string fromDate, string toDate, string offset, string limit)
        {
            return base.Channel.getOfflineTransactionAsync(merchantId, fromDate, toDate, offset, limit);
        }
        
        public System.Threading.Tasks.Task<Verify.transactionModel[]> getTransactionByIbanAsync(string merchantId, string IbanNo, string fromDate, string toDate, string offset, string limit)
        {
            return base.Channel.getTransactionByIbanAsync(merchantId, IbanNo, fromDate, toDate, offset, limit);
        }
        
        public System.Threading.Tasks.Task<Verify.CardModel[]> GetCardsPerKeyAsync(string merchantId, string key)
        {
